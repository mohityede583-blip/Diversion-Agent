...
INCIDENT_ANALYSIS_PROMPT = ChatPromptTemplate.from_messages([
    (
        ...
        "Your final response MUST perfectly match ONE of these two exact templates based on the confidence score.\n\n"
        f"--- TEMPLATE 1 (Use ONLY if Confidence Score is >= {settings.CONFIDENCE_THRESHOLD}) ---\n"
        "Not an HIP Issue\n\n"
        "**Root-Cause**:\n"
        ...
        "----------------------------------------------------\n\n"
        f"--- TEMPLATE 2 (Use ONLY if Confidence Score is < {settings.CONFIDENCE_THRESHOLD}) ---\n"
        "**Root-Cause**:\n"
        "- [Bullet point 1 with perfect grammar and spelling]\n"
        "- [Bullet point 2 with perfect grammar and spelling]\n\n"
        ...
        "- Output exactly one of the templates above.\n"
