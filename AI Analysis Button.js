// Function triggered by the Onclick field above
function triggerAIIncidentAnalysis() {
    ...
    if (!shortDesc && !description) {
        g_form.showFieldMsg('short_description', 'Please ensure Short description or Description is filled before analyzing.', 'error');
        return;
    }

    g_form.addInfoMessage('✨ Analyzing incident with AI...');
...
function showAIAnalysisModal(incNumber, analysisText, matchedIncidents) {
    ...
    h3.innerHTML = '✨ AI Incident Analysis: ' + (incNumber || 'Incident');
